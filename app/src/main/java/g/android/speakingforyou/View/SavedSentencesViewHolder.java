...
public class SavedSentencesViewHolder extends RecyclerView.ViewHolder {
    ...
    public ImageView getReorderView() {
        return reorderView;
    }

    ImageView reorderView;

    public SavedSentencesViewHolder(View itemView, ClickListener listener) {
        super(itemView);

        listenerRef = new WeakReference<>(listener);
        sentence = ((TextView) itemView.findViewById(R.id.sentence_saved_cell));
